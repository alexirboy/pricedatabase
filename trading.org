...
- A reversal of a move, on the TF below it, looks like a double top/bottom mostly. This means that waiting for a LTF double top/bottom is something that can be used to assess whether the TTF move may be changing and use that as a opportunity to enter.
...
- Remember the order in which you are looking to filter out whether stuff is a good trade to take or not
- are you going against the current HTF move direction or against it? that is an important question that dictates a lot of stuff
- if you was to buy sell at market, or closest S/R, what event would need to happen for you to profit 4.2 pips? How likely is that?
...
- Remember missing a trade you do not lose anything. You can be slow to enter and quick to leave if you want and that is not a bad strategy.
