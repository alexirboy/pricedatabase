...
*Conclusion*
:Conclusion:
1. There is not a lot of correlation between where the previous move started from and this current RB move.
2. does not really
...
|       2 | HHTF    | RB        | HTF SS                                |
|       3 | HTF     | RB        | RR at HTF RR at HHHTF RR              |
|       4 | TTF     | RB        | F38%                                  |
|      14 | TTF     | RB        | SS at HTF F38%                        |
|      24 | HTF     | RB        | F61% at HTF F38%                      |
|      25 | TTF     | RB        | F61% at HTF F23%                      |
|      35 | TTF     | RB        | SS at HTF SS(mini move)               |
|      44 | HTF     | RB        | SS at HTF SS                          |
|      45 | TTF     | RB        | SS at HTF F38%                        |
|      47 | TTF     | RB        | SS at HTF SS at HHTF SS at HHHTF F50% |
|      52 | TTF     | RB        | F38% at HTF F38% - synonymous moves   |
|      53 | TTF     | RB        | F38%                                  |
|      57 | TTF     | RB        | RR at HTF F61%                        |
|      59 | TTF     | RB        | SS at HTF F38%                        |
|      64 | HTF     | RB/R      | F50% at HTF SS at HHTF F50%           |
|      65 | TTF     | RB        | F61% at HTF F38% within HTF SS        |
|      69 | TTF     | RB        | SS at HTF SS                          |
|      71 | HTF     | RB        | RR at HTF F23%                        |
|      72 | TTF     | RB        | RR at HTF F38%                        |
|      82 | TTF     | RB        | F38%                                  |
|      89 | HTF     | RB        | F61%                                  |
|      94 | TTF     | RB        | RR                                    |
|      98 | TTF     | RB        | F50%                                  |
|     101 | HTF     | RB        | RR at HTF F38%                        |
|     102 | TTF     | RB        | HTF F61% at HTF RR                    |
|     109 | TTF     | R/RB      | RR at HTF F38%                        |
|     112 | HTF     | RB        | F61%                                  |
|     113 | TTF     | RB        | SS at HTF F61% within HTF SS          |
|     115 | TTF     | RB        | SS at HTF SS                          |
|     116 | HTF     | R/RB      | F50%                                  |
|     117 | TTF     | RB        | F50% at HTF F50% - synonymous moves   |
|     121 | TTF     | RB        | F50% at HTF F50% - synonymous moves   |
|     122 | HTF     | RB        | RR at HTF F50%                        |
|     125 | TTF     | RB        | RR at HTF RR                          |
*** Splits
**** TTF S/R
#+BEGIN_SRC awk :in-file ../08_10_2020.csv :exports results
BEGIN {
...
BEGIN {
    FS=","
    print "Move No\tMove TF\tThis move\tLine previous move started from"
}
$8 ~ "RB" && $6 ~ /^F[0-9].%$/ {print NR"\t"$1"\t"$8"\t"$6}
#+END_SRC
#+RESULTS:
| Move No | Move TF | This move | Line previous move started from |
|       4 | TTF     | RB        | F38%                            |
|      53 | TTF     | RB        | F38%                            |
|      82 | TTF     | RB        | F38%                            |
|      89 | HTF     | RB        | F61%                            |
...
$8 ~ "RB" && $6 ~ "synonymous" {print NR"\t"$1"\t"$8"\t"$6}
#+END_SRC
#+RESULTS:
| Move No | Move TF | This move | Line previous move started from     |
|      52 | TTF     | RB        | F38% at HTF F38% - synonymous moves |
...
$8 ~ "RB" && $6 ~ /H\w* [SS|RR]/ {print NR"\t"$1"\t"$8"\t"$6}
#+END_SRC
#+RESULTS:
