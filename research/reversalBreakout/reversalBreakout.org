...
*Need to edit the format of this stuff. Seperation of DB and DT is not important because the structure between them is the same, both have two swings of the same style.
Format it instead as OS, DB/DT, HDT/HDB, QDB/QDT instead.*
